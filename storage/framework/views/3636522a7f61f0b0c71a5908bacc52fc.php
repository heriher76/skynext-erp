...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="<?php echo e(route('invoice.export')); ?>" class="btn btn-sm btn-primary" data-bs-toggle="tooltip"
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    <?php echo e(Form::date('issue_date', isset($_GET['issue_date']) ? $_GET['issue_date'] : '', ['class' => 'form-control month-btn', 'id' => 'pc-daterangepicker-1'])); ?>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($invoice->project->project_name ?? ''); ?></td>
                                                ...
                                                <span>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('copy invoice')): ?>
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="#"
                                                                id="<?php echo e(route('invoice.link.copy', [$invoiceID])); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sakkaindonesia/resources/views/invoice/index.blade.php ENDPATH**/ ?>