...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><?php echo e(__('Invoice Edit')); ?></li>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <?php echo e(Form::model($invoice, ['route' => ['invoice.update', $invoice->id], 'method' => 'PUT', 'class' => 'w-100'])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group" id="customer-box">
                                ...
                                <?php echo e(Form::select('customer_id', $customers, null, ['class' => 'form-control select ', 'id' => 'customer', 'data-url' => route('invoice.customer'), 'required' => 'required'])); ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <?php echo e(Form::select('project_id', $projects, null, ['class' => 'form-control select', 'id' => 'project', 'data-url' => route('invoice.project'), 'required' => 'required'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            <?php echo e(Form::text('ref_number', null, ['class' => 'form-control'])); ?>
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0">
                                        <?php echo e(Form::select('item', $product_services, null, ['class' => 'form-control item select', 'data-url' => route('invoice.product')])); ?>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group price-input input-group search-form">
                                            <?php echo e(Form::text('quantity', null, ['class' => 'form-control quantity', 'required' => 'required', 'placeholder' => __('Qty'), 'required' => 'required'])); ?>
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form">
                                            <?php echo e(Form::text('price', null, ['class' => 'form-control price', 'required' => 'required', 'placeholder' => __('Price'), 'required' => 'required'])); ?>
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form">
                                            <?php echo e(Form::text('discount', null, ['class' => 'form-control discount', 'required' => 'required', 'placeholder' => __('Discount')])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/invoice/edit.blade.php ENDPATH**/ ?>