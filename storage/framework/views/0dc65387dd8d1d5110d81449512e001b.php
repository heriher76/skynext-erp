                        ...
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0"><a class="text-dark"
                                        href="<?php echo e(route('projects.show', $project)); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>"><?php echo e($project->project_name); ?></a>
                                </h5>
                            </div>
                            ...
                            <div class="row g-2 justify-content-between">
                                <?php if(!empty($project->department)): ?>
                                    <div class="col-auto"><span
                                            class="badge rounded-pill bg-success"><?php echo e($project->department->name ?? ''); ?></span>
                                    </div>
                                <?php endif; ?>
                                <div class="col-auto"><span
                                        class="badge rounded-pill bg-<?php echo e(\App\Models\Project::$status_color[$project->status]); ?>"><?php echo e(__(\App\Models\Project::$project_status[$project->status])); ?></span>
                                </div>
                        ...
                        <div class="card mb-0 mt-3">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-6">
                                        <h6
                                            class="mb-0 <?php echo e(strtotime($project->start_date) < time() ? 'text-danger' : ''); ?>">
...
<?php endif; ?>
<?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/projects/grid.blade.php ENDPATH**/ ?>