...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <a href="#" onclick="saveAsPDF();" class="btn btn-sm btn-primary dwn" data-toggle="tooltip"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="row" id="printableArea">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="min-height: 280px;">
                            <div class="row align-items-center">
                                ...
                                <div class="col-5 ">
                                    <?php
                                        $task_percentage = $project->project_progress($project, $last_task->id)['percentage'];
                                                ...
                                                <svg viewBox="0 0 36 36"
                                                    ...
                                                    <path class="circle" stroke-dasharray="<?php echo e($data); ?>, 100"
                                                        d="M18 2.0845
                                                                                            a 15.9155 15.9155 0 0 1 0 31.831
                                                                                            a 15.9155 15.9155 0 0 1 0 -31.831" />
                                                    <text x="18" y="20.35" class="percentage"><?php echo e($data); ?>%</text>
                                                </svg>
                                            </div>
                                        </div>
                                    </div>
                ...
                <?php
                    $lastStage = \App\Models\TaskStage::where('created_by', \Auth::user()->creatorId())
                        ->orderby('id', 'desc')
                        ->first();
                ...
                <div class="col-md-12  row d-sm-flex align-items-center justify-content-end">
                    <div class="col-1">
                        <button class=" btn btn-primary mx-2 btn-filter apply">
                            <a href="<?php echo e(route('project_report.export', $project->id)); ?>"
                                class="text-white"><?php echo e(__('Export')); ?></a>
                        </button>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table datatable">
                                    ...
                                    <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <a href="#!" data-size="md"
                                                    data-url="<?php echo e(route('projects.tasks.show', [$project->id, $task->id])); ?>"
                                        ...
                                        <td>
                                            <div class="">
                                                <span
                                                    class="badge p-2 px-3 status_badge rounded bg-<?php echo e(\App\Models\ProjectTask::$priority_color[$task->priority]); ?>"><?php echo e(\App\Models\ProjectTask::$priority[$task->priority]); ?></span>
                                            </div>
                                        </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/project_report/show.blade.php ENDPATH**/ ?>