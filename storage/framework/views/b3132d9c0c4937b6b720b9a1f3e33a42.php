                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="channel"
                                value="<?php echo e(request()->channel == 'activity' ? 'activity' : ''); ?>">
                            <div class="row d-flex align-items-center justify-content-end">
                                        ...
                                        <select class="select form-select" name="all_users" id="all_users">
                                            ...
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($user->id); ?>"
                                                    <?php echo e(isset($_GET['all_users']) && $_GET['all_users'] == $user->id ? 'selected' : ''); ?>>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                        ...
                                        <?php echo e(Form::date('start_date', isset($_GET['start_date']) ? $_GET['start_date'] : '', ['class' => 'form-control month-btn'])); ?>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                        ...
                                        <?php echo e(Form::date('end_date', isset($_GET['end_date']) ? $_GET['end_date'] : '', ['class' => 'form-control month-btn'])); ?>
                                ...
                                <div class="col-auto float-end ms-2 mt-4">
                                    ...
                                    <a href="<?php echo e(route('project_report.index')); ?>" class="btn btn-sm btn-danger"
                                ...
                                <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <p class="mb-0"><a
                                                        class="name mb-0 h6 text-sm"><?php echo e($project->project_name); ?></a></p>
                                            </div>
                                        </td>
                                    ...
                                    <td class="">
                                        <h6 class="mb-0 text-success">
                                            <?php echo e($project->project_progress($project, $last_task->id)['percentage']); ?>

                                        </h6>
                                        <div class="progress mb-0">
                                            <div class="progress-bar bg-<?php echo e($project->project_progress($project, $last_task->id)['color']); ?>"
                                                style="width: <?php echo e($project->project_progress($project, $last_task->id)['percentage']); ?>;">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="">
                                        <span
                                            class="badge bg-<?php echo e(\App\Models\Project::$status_color[$project->status]); ?> p-2 px-3 rounded status_badge"><?php echo e(__(\App\Models\Project::$project_status[$project->status])); ?></span>
                                    </td>
                                    <td class="">
                        ...
                        <?php else: ?>
                            <tr>
                                <th scope="col" colspan="7">
                                    <h6 class="text-center"><?php echo e(__('No Projects Found.')); ?></h6>
                                </th>
                            </tr>
                        <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/project_report/index.blade.php ENDPATH**/ ?>