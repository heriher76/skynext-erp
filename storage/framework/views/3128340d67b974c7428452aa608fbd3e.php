                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5><?php echo e(__('Storage Limit')); ?>
                                        ...
                                        <small class="float-end text-muted"><?php echo e($users->storage_limit . 'MB'); ?> / <?php echo e($plan->storage_limit . 'MB'); ?></small>
                                    </h5>
                                </div>
                                <div class="card-body">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/sakkaindonesia/resources/views/dashboard/account-dashboard.blade.php ENDPATH**/ ?>