        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-invoice-tab" data-bs-toggle="pill" href="#pills-invoice"
                            role="tab" aria-controls="pills-invoice"
                            aria-selected="false"><?php echo e(__('Invoice Print Setting')); ?></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/settings/print.blade.php ENDPATH**/ ?>