                                    ...
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3 fc-event-title-container">
                                                <h6 class="m-0 text-sm fc-event-title text-primary"><?php echo e($task['title']); ?>

                                                </h6>
                                                <small class="text-muted"><?php echo e($task['start']); ?> to
                                                    <?php echo e($task['end']); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->startPush('script-page'); ?>
    ...
    <script type="text/javascript">
        ...
        function get_data() {
            ...
            $.ajax({
                url: $("#task_calendar").val() +
                    "/calendar/get_task_data<?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/tasks/calendar.blade.php ENDPATH**/ ?>