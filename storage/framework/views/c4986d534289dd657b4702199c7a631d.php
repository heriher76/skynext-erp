...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if($view == 'grid'): ?>
            <a href="<?php echo e(route('taskBoard.view', 'list')); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>"
                class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="<?php echo e(__('List View')); ?>">
                <span class="btn-inner--text"><i class="ti ti-list"></i></span>
            </a>
        <?php else: ?>
            <a href="<?php echo e(route('taskBoard.view', 'grid')); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>"
                class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="<?php echo e(__('Card View')); ?>">
                                ...
                                <div class="card m-3 card-progress border shadow-none" id="<?php echo e($task->id); ?>"
                                    ...
                                    <div class="card-body">
                                        <div class="row align-items-center mb-2">
                                            <div class="col-6">
                                                <span
                                                    class="badge p-2 px-3 rounded bg-<?php echo e(\App\Models\ProjectTask::$priority_color[$task->priority]); ?>"><?php echo e(\App\Models\ProjectTask::$priority[$task->priority]); ?></span>
                                            </div>
                                            <div class="col-6 text-end">
                                                <?php if(str_replace('%', '', $task->taskProgress($task)['percentage']) > 0): ?>
                                                    <span
                                                        class="text-sm"><?php echo e($task->taskProgress($task)['percentage']); ?></span>
                                        ...
                                        <a class="h6 task-name-break"
                                            href="<?php echo e(route('projects.tasks.index', !empty($task->project) ? $task->project->id : '')); ?>"><?php echo e($task->name); ?></a>
                                        <div class="row align-items-center">
                                                ...
                                                <div class="actions d-flex justify-content-between mt-2 mb-2">
                                                    <?php if(count($task->taskFiles) > 0): ?>
                                                        <div class="action-item mr-2"><i
                                                                class="ti ti-paperclip mr-2"></i><?php echo e(count($task->taskFiles)); ?>
                                            ...
                                            <div class="col-6">
                                                <?php if(!empty($task->end_date) && $task->end_date != '0000-00-00'): ?>
                                                    <small
                                                        <?php if(strtotime($task->end_date) < time()): ?> class="text-danger" <?php endif; ?>><?php echo e(Utility::getDateFormated($task->end_date)); ?></small>
                                                <?php endif; ?>
                                            </div>
                                            <div class="col-6 text-end">
                                                        ...
                                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($key < 3): ?>
                                                                <a href="#" class="avatar rounded-circle avatar-sm">
                                                                    <img class="hweb"
                                                                        data-original-title="<?php echo e(!empty($user) ? $user->name : ''); ?>"
...
<script>
    ...
    function ajaxFilterTaskView(task_sort, keyword = '', status = '') {
        ...
        $.ajax({
            url: '<?php echo e(route('project.taskboard.view')); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>',
            data: data,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/project_task/grid.blade.php ENDPATH**/ ?>