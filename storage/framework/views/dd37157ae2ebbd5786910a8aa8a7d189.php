...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create payment')): ?>
            <a href="#" data-url="<?php echo e(route('payment.create')); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" data-size="lg"
                data-title="<?php echo e(__('Create New Payment')); ?>" title="<?php echo e(__('Create')); ?>" class="btn btn-sm btn-primary">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <?php echo e(Form::open(['route' => ['payment.index'], 'method' => 'GET', 'id' => 'payment_form'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::date('date', isset($_GET['date']) ? $_GET['date'] : '', ['class' => 'form-control month-btn ', 'id' => 'pc-daterangepicker-1'])); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('account', $account, isset($_GET['account']) ? $_GET['account'] : '', ['class' => 'form-control select', 'id' => 'choices-multiple'])); ?>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                        <div class="btn-box">
                                            ...
                                            <?php echo e(Form::select('category', $category, isset($_GET['category']) ? $_GET['category'] : '', ['class' => 'form-control select', 'id' => 'choices-multiple2'])); ?>
                                        ...
                                        <td>
                                            <?php if(!empty($payment->add_receipt)): ?>
                                                <a class="action-btn bg-primary ms-2 btn btn-sm align-items-center"
                                                    href="<?php echo e($paymentpath . '/' . $payment->add_receipt); ?>" download="">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit payment')): ?>
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                            data-url="<?php echo e(route('payment.edit', $payment->id)); ?>"
                                                            data-ajax-popup="true" data-title="<?php echo e(__('Edit Payment')); ?>"
                                                            data-size="lg" data-bs-toggle="tooltip" title="<?php echo e(__('Edit')); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete payment')): ?>
                                                    <div class="action-btn bg-danger ms-2">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Delete')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/payment/index.blade.php ENDPATH**/ ?>