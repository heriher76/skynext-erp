            ...
            <li class="dropdown dash-h-item drp-language">
                ...
                <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                    ...
                    <?php if(\Auth::user()->type == 'super admin'): ?>
                        <a data-url="<?php echo e(route('create.language')); ?>" class="dropdown-item text-primary"
                            data-ajax-popup="true" data-title="<?php echo e(__('Create New Language')); ?>">
                            <?php echo e(__('Create Language')); ?>

                        </a>
                        <a class="dropdown-item text-primary"
                            href="<?php echo e(route('manage.language', [isset($lang) ? $lang : 'english'])); ?>"><?php echo e(__('Manage Language')); ?></a>
                    <?php endif; ?>
                </div>
            </li>
        </ul>
...
<?php /**PATH /Applications/MAMP/htdocs/sakkaindonesia/resources/views/partials/admin/header.blade.php ENDPATH**/ ?>