...
<?php $__env->startPush('script-page'); ?>
    ...
    <script>
        ...
        $(document).on('change', '#project', function() {
            $('#detail_budget').removeClass('d-none');
            $('#detail_budget').addClass('d-block');
            var id = $(this).val();
            var url = $(this).data('url');
            $.ajax({
                url: url,
                ...
                success: function(data) {
                    if (data != '') {
                        budget = data;
                        var finalNominal = formatRupiah(data, 'Rp. ');
                        $('#detail_budget').html('Budget: ' + finalNominal);
                    } else {
                        $('#detail_budget').removeClass('d-block');
                        $('#detail_budget').addClass('d-none');
                    }
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(['url' => 'invoice', 'class' => 'w-100', 'id' => 'formCreateInvoice'])); ?>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                            <div class="form-group" id="customer-box">
                                ...
                                <?php echo e(Form::select('customer_id', $customers, $customerId, ['class' => 'form-control select', 'id' => 'customer', 'data-url' => route('invoice.customer'), 'required' => 'required'])); ?>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <?php echo e(Form::select('project_id', $projects, 0, ['class' => 'form-control select', 'id' => 'project', 'data-url' => route('invoice.project'), 'required' => 'required'])); ?>

                                            <small id="detail_budget" class="d-none"></small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-6" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::select('category_id', $category, null, ['class' => 'form-control select'])); ?>
                                ...
                                <div class="col-md-6" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            ...
                                            <?php echo e(Form::text('ref_number', '', ['class' => 'form-control'])); ?>
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                <tr>
                                    ...
                                    <td width="25%" class="form-group pt-0">
                                        <?php echo e(Form::select('item', $product_services, '', ['class' => 'form-control select2 item', 'data-url' => route('invoice.product'), 'required' => 'required'])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/invoice/create.blade.php ENDPATH**/ ?>