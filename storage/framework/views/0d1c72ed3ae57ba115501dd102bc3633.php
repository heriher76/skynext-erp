                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <p class="mb-0"><a href="<?php echo e(route('projects.show', $project)); ?>"
                                    ...
                                    <td class="">
                                        <?php if(!empty($project->department)): ?>
                                            <span
                                                class="badge bg-success p-2 px-3 rounded"><?php echo e($project->department->name ?? ''); ?></span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="">
                                        <span
                                            class="badge bg-<?php echo e(\App\Models\Project::$status_color[$project->status]); ?> p-2 px-3 rounded"><?php echo e(__(\App\Models\Project::$project_status[$project->status])); ?></span>
                                    </td>
                                    <td class="">
                                    ...
                                    <span>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="#"
                                                    ...
                                                    title="<?php echo e(__('Invite User')); ?>"
                                                    data-title="<?php echo e(__('Invite User')); ?>">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit project')): ?>
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#"
                                                    class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                    data-url="<?php echo e(URL::to('projects/' . $project->id . '/edit')); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>"
                                                    data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip"
                                                    title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Project')); ?>">
...
<?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/projects/list.blade.php ENDPATH**/ ?>