        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.add_usr', function() {
                ...
                $('#usr_txt_' + crr_id).html($('#usr_txt_' + crr_id).html() == 'Add' ?
                    '<?php echo e(__('Added')); ?>' : '<?php echo e(__('Add')); ?>');
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            var html =
                                ...
                                '                            <a href="#" class="mx-3 btn btn-sm  align-items-center delete-checklist" role="button" data-url="' +
                                data.deleteUrl + '">' +
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            var html = '<div class="card mb-3 border shadow-none task-file">' +
                                ...
                                '                                <a href="<?php echo e(asset(Storage::url('tasks'))); ?>/' +
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a
            href="<?php echo e(route('projects.show', $project->id)); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>"><?php echo e(ucwords($project->project_name)); ?></a>
    </li>
                ...
                <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col">
                        <div class="card">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create project task')): ?>
                                    <div class="float-end">
                                        <a href="#" data-size="lg"
                                            ...
                                            title="<?php echo e(__('Add Task in ') . $stage->name); ?>" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body kanban-box" id="task-list-<?php echo e($stage->id); ?>"
                                ...
                                <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taskDetail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="card draggable-item" id="<?php echo e($taskDetail->id); ?>">
                                        <div class="pt-3 ps-3">
                                            <div
                                                class="badge-xs badge bg-<?php echo e(\App\Models\ProjectTask::$priority_color[$taskDetail->priority]); ?> p-2 px-3 rounded">
                                                <?php echo e(__(\App\Models\ProjectTask::$priority[$taskDetail->priority])); ?></div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                <ul class="list-inline mb-0">
                                                    <li class="list-inline-item d-inline-flex align-items-center"
                                                        ...
                                                        <i class="f-16 text-primary ti ti-file"></i>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item d-inline-flex align-items-center"
                                                        ...
                                                        <i class="f-16 text-primary ti ti-message"></i>
                                                    ...
                                                    <li class="list-inline-item d-inline-flex align-items-center"
                                                        ...
                                                        <i
                                                            class="f-16 text-primary ti ti-list"></i><?php echo e($taskDetail->countTaskChecklist()); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/project_task/index.blade.php ENDPATH**/ ?>