...
<div class="modal-body">
    ...
    <?php if($plan->chatgpt == 1): ?>
        <div class="text-end">
            <a href="#" data-size="md" class="btn  btn-primary btn-icon btn-sm" data-ajax-popup-over="true"
                data-url="<?php echo e(route('generate', ['project task'])); ?>" data-bs-placement="top"
    ...
    <div class="row">
        ...
        <input type="hidden" name="estimated_hrs" value="0">
...
<?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/project_task/create.blade.php ENDPATH**/ ?>