...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a
            href="<?php echo e(route('projects.index')); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>"><?php echo e(__('Project')); ?></a>
    </li>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        ...
        <a href="#" class="btn btn-primary btn-sm" role="button" data-bs-toggle="dropdown" aria-haspopup="true"
            aria-expanded="false">
        ...
        <div class="dropdown-menu dropdown-menu-right task-filter-actions dropdown-steady" id="task_status">
            ...
            <hr class="my-0">
            <a class="dropdown-item filter-action pl-4 active" href="#"
                data-val="see_my_tasks"><?php echo e(__('See My Tasks')); ?></a>
            <hr class="my-0">
            ...
            <hr class="my-0">
            <a class="dropdown-item filter-action filter-other pl-4" href="#"
                data-val="due_today"><?php echo e(__('Due Today')); ?></a>
            <a class="dropdown-item filter-action filter-other pl-4" href="#"
                data-val="over_due"><?php echo e(__('Over Due')); ?></a>
            <a class="dropdown-item filter-action filter-other pl-4" href="#"
                data-val="starred"><?php echo e(__('Starred')); ?></a>
        </div>
        ...
        <?php else: ?>
            <a href="<?php echo e(route('taskBoard.view', 'grid')); ?><?php echo e(request()->channel == 'activity' ? '?channel=activity' : ''); ?>"
                class="btn btn-primary btn-sm" data-bs-toggle="tooltip" title="<?php echo e(__('Grid View')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/project_task/taskboard.blade.php ENDPATH**/ ?>