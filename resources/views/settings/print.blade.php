                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="pills-invoice-tab" data-bs-toggle="pill" href="#pills-invoice"
                            ...
                            aria-selected="false">{{ __('Invoice Print Setting') }}</a>
                                ...
                                <div class="col-md-3">
                                    <div class="card-body">
                                        ...
                                        <form id="setting-form" method="post"
                                            action="{{ route('proposal.template.setting') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label for="address"
                                                    class="col-form-label">{{ __('Proposal Template') }}</label>
