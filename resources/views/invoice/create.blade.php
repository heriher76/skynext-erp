...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'invoice', 'class' => 'w-100', 'id' => 'formCreateInvoice']) }}
        <div class="col-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            {{ Form::select('project_id', $projects, 0, ['class' => 'form-control select', 'id' => 'project', 'data-url' => route('invoice.project'), 'required' => 'required']) }}
