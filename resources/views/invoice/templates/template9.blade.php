        ...
        <div class="invoice-body" style="padding-right: 0;">
            ...
            <table class="add-border invoice-summary" style="padding-top: 50px;">
                <thead style="background: {{ $color }};color:{{ $font_color }}">
                    <tr>
                        <th colspan=2>
                            <center>{{ __('Informasi Pembayaran') }}</center>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td width=50%><img src="{{ url('assets/images/logo_bri.png') }}" style="width:25px;">
                            &nbsp;&nbsp;&nbsp;BANK BRI
                        </td>
                        <td width=50%>
                    ...
                    <tr>
                        <td width=50%><img src="{{ url('assets/images/logo_bca.png') }}" style="width:25px;">
                            &nbsp;&nbsp;&nbsp;BANK BCA</td>
                        <td width=50%>
                            <h3>2832136281</h3>
                        </td>
            ...
            <table class="add-border invoice-summary">
                <thead style="background: {{ $color }};color:{{ $font_color }}">
                    <tr>
                        <th colspan=2>
                            <center>{{ __('Layanan Pelanggan') }}</center>
                        </th>
                    </tr>
                </thead>
                <tbody>
