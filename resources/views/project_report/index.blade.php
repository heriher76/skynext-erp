                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <input type="hidden" name="channel"
                                value="{{ request()->channel == 'activity' ? 'activity' : '' }}">
                            <div class="row d-flex align-items-center justify-content-end">
                                        ...
                                        <select class="select form-select" name="all_users" id="all_users">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}"
                                                    {{ isset($_GET['all_users']) && $_GET['all_users'] == $user->id ? 'selected' : '' }}>
                                                    {{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-auto float-end ms-2 mt-4">
                                    ...
                                    <a href="{{ route('project_report.index') }}" class="btn btn-sm btn-danger"
                        ...
                        <tbody>
                            @if (isset($projects) && !empty($projects) && count($projects) > 0)
                                @foreach ($projects as $key => $project)
                                    ...
                                    <td class="">
                                        <span
                                            class="badge bg-{{ \App\Models\Project::$status_color[$project->status] }} p-2 px-3 rounded status_badge">{{ __(\App\Models\Project::$project_status[$project->status]) }}</span>
                                    </td>
                                    <td class="">
                                        @can('manage project')
