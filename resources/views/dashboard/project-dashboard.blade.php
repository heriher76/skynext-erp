    ...
    <script>
        (function() {
            ...
            var optionsPcs = {
                ...
                series: [{
                    name: 'Total Pcs',
                    data: {!! json_encode(array_values($home_data['pcsByMonth'])) !!}
                }, ],
                xaxis: {
                    categories: {!! json_encode(array_keys($home_data['pcsByMonth'])) !!},
                },
                colors: ['#fff'],
                fill: {
                    type: 'solid',
...
@section('content')
    <div class="row">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mb-3 mb-sm-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    <small class="text-muted">{{ __('Total') }}</small>
                                    <h6 class="m-0">{{ __('Pcs') }}</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto text-end">
                            <h4 class="m-0">{{ $home_data['total_invoice']['total'] }}</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-auto text-end">
                                <h4 class="m-0">{{ \Auth::user()->priceFormat($home_data['total_budget']['total']) }}
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive ">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr class="py-5">
                                        <td class="text-center mb-0" colspan="3">{{ __('No Due Projects Found.') }}
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                ...
                <div class="card-header">
                    <h5>{{ __('Total Pcs') }}
                        <span class="float-end">
                            <form action="{{ url('project-dashboard') }}" method="GET" id="formProjectDashboard">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5>{{ __('Tasks Overview') }} <span class="float-end"> <small
                                class="text-muted">{{ __('Total Completed task in last 7 days') }}</small></span></h5>
