...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a
            href="{{ route('projects.show', $project->id) }}{{ request()->channel == 'activity' ? '?channel=activity' : '' }}">{{ ucwords($project->project_name) }}</a>
    </li>
                                ...
                                @can('create project task')
                                    <div class="float-end">
                                        <a href="#" data-size="lg"
                                            ...
                                            title="{{ __('Add Task in ') . $stage->name }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-body kanban-box" id="task-list-{{ $stage->id }}"
                                ...
                                @foreach ($tasks as $taskDetail)
                                    <div class="card draggable-item" id="{{ $taskDetail->id }}">
                                        <div class="pt-3 ps-3">
                                            <div
                                                class="badge-xs badge bg-{{ \App\Models\ProjectTask::$priority_color[$taskDetail->priority] }} p-2 px-3 rounded">
                                                {{ __(\App\Models\ProjectTask::$priority[$taskDetail->priority]) }}</div>
                                        </div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <ul class="list-inline mb-0">
                                                    ...
                                                    <li class="list-inline-item d-inline-flex align-items-center"
                                                        ...
                                                        <i
                                                            class="f-16 text-primary ti ti-list"></i>{{ $taskDetail->countTaskChecklist() }}
                                                    </li>
                                                </ul>
                                                <div class="user-group">
