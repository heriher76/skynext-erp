<div class="modal-body task-id" id="{{ $task->id }}">
    <div class="card">
        <div class="card-body">
                    ...
                    <div class="d-flex align-items-start">
                        <div class="ms-2">
                            ...
                            <h3 class="mb-0 text-success">
                                {{ !empty($task->estimated_hrs) ? number_format($task->estimated_hrs) : '-' }}</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-start">
                        <div class="ms-2">
                            ...
                            <h3 class="mb-0 text-primary">
                                {{ !empty($task->milestone) ? $task->milestone->title : '-' }}</h3>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="ms-2">
                                ...
                                <div class="progress mb-0">
                                    <div id="progress-result" class="tab-pane tab-example-result fade show active"
                                        role="tabpanel" aria-labelledby="progress-result-tab">
                                        <input type="range" class="task_progress custom-range"
                                            value="{{ $task->progress }}" id="task_progress" name="progress"
            ...
            <div class="row mt-4">
                <div class="col">
                    <p class="text-sm text-muted mb-2">{{ !empty($task->description) ? $task->description : '-' }}
                    </p>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-4 align-items-center">
                ...
                <div class="col-6 ">
                    <div class="float-end">
                        <a data-bs-toggle="collapse" href="#form-checklist" role="button" aria-expanded="false"
                            aria-controls="form-checklist" data-bs-toggle="tooltip" title="{{ __('Add item') }}"
            ...
            <div class="checklist" id="checklist">
                <form id="form-checklist" class="collapse pb-2"
                    ...
                    <div class="card border shadow-none">
                        <div class="px-3 py-2 row align-items-center">
                            ...
                            <div class="col-2 card-meta d-inline-flex align-items-center">
                                <button class="btn btn-sm btn-primary" type="button" id="checklist_submit"
                        ...
                        <div class="px-3 py-2 row align-items-center">
                            <div class="col">
                                <div class="form-check form-check-inline">
                                    ...
                                    <label class="form-check-label h6 text-sm"
                                        for="check-item-{{ $checklist->id }}">{{ $checklist->name }}</label>
                                </div>
                            </div>
                            <div class="col-auto">
                                <div class="action-btn bg-danger ms-2">
                                    <a href="#" class="mx-3 btn btn-sm  align-items-center delete-checklist"
                                        data-url="{{ route('checklist.destroy', [$task->project_id, $checklist->id]) }}">
                                        <i data-bs-toggle="tooltip" title="{{ __('Delete') }}"
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-4 align-items-center">
                ...
                <div class="col-6 ">
                    <div class="float-end">
                        <a data-bs-toggle="collapse" href="#add_file" role="button" aria-expanded="false"
                            aria-controls="add_file" data-bs-toggle="tooltip" title="{{ __('Add attachment') }}"
                            class="btn btn-sm btn-primary">
                            <i class="ti ti-plus"></i>
                        </a>
                    </div>
                        ...
                        <div class="px-3 py-2 row align-items-center">
                            ...
                            <div class="col-2 card-meta d-inline-flex align-items-center">
                                <button class="btn btn-sm btn-primary" type="button" id="file_attachment_submit"
                                    data-action="{{ route('comment.store.file', [$task->project_id, $task->id]) }}"
                                    data-bs-toggle="tooltip" title="{{ __('Create') }}">
                                    <i class="ti ti-check"></i>
                                </button>
                            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto actions">
                                        <div class="action-btn bg-secondary ms-2">
                                            <a href="{{ asset(Storage::url('tasks/' . $file->file)) }}" download
                                                class="mx-3 btn btn-sm  align-items-center" role="button">
                                        ...
                                        @auth('web')
                                            <div class="action-btn bg-danger ms-2">
                                                <a href="#"
                                                    class="mx-3 btn btn-sm  align-items-center delete-comment-file"
                                                    data-url="{{ route('comment.destroy.file', [$task->project_id, $task->id, $file->id]) }}">
                                                    <i data-bs-toggle="tooltip" title="{{ __('Delete') }}"
                                                        class="ti ti-trash text-white"></i>
                                                </a>
                                            </div>
            ...
            <div class="row ">
                ...
                @if ($plan->chatgpt == 1)
                    <div class="col-6 text-end">
                        <a href="#" data-size="md" class="btn btn-primary btn-icon btn-sm mb-3 me-2"
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <div class="action-btn bg-danger me-2">
                                    <a href="#" class="mx-3 btn btn-sm  align-items-center delete-comment"
        ...
        <div class="card-footer">
            ...
            <div class="col-12 d-flex">
                <div class="avatar me-3">
                    <img data-original-title="{{ !empty(\Auth::user()) ? \Auth::user()->name : '' }}"
                        @if (\Auth::user()->avatar) src="{{ asset('/storage/uploads/avatar/' . \Auth::user()->avatar) }}" @else src="{{ asset('/storage/uploads/avatar/avatar.png') }}" @endif
                        title="{{ Auth::user()->name }}" class="wid-40 rounded-circle ml-3">
                </div>
                <div class="form-group mb-0 form-send w-100">
                    <form method="post" class="card-comment-box" id="form-comment"
                        data-action="{{ route('task.comment.store', [$task->project_id, $task->id]) }}">
                        <textarea rows="1" class="form-control grammer_textarea" name="comment" data-toggle="autosize"
                            placeholder="{{ __('Add a comment...') }}"></textarea>
                    </form>
                </div>

                <button id="comment_submit" class="btn btn-send"><i
                        class="text-primary ti ti-brand-telegram"></i></button>
                    ...
                    if (task_id) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                $('.task-list-items').find('#' + task_id).attr('style',
