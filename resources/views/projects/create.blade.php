{{ Form::open(['url' => 'projects?channel=' . request()->channel, 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
<div class="modal-body">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="form-group">
                @if (request()->channel == 'activity')
                    {{ Form::label('project_name', __('Activity Name'), ['class' => 'form-label']) }}
                @else
    ...
    <div class="row">
        ...
        <div class="col-6 col-md-6">
            <div class="form-group">
                ...
                {{ Form::number('priority', null, ['class' => 'form-control', 'min' => '0', 'maxlength' => '8']) }}
            </div>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        @if (request()->channel == 'activity')
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    {{ Form::label('channel', __('Type'), ['class' => 'form-label']) }}
            ...
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    {{ Form::label('department_id', __('Division'), ['class' => 'form-label']) }}
                    <select name="department_id" id="department_id" class="form-control main-element">
                        @foreach (\App\Models\Department::get() as $k => $v)
