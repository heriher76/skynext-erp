                        ...
                        <div class="card-header border-0 pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <h5 class="mb-0"><a class="text-dark"
                                        href="{{ route('projects.show', $project) }}{{ request()->channel == 'activity' ? '?channel=activity' : '' }}">{{ $project->project_name }}</a>
                                </h5>
                            </div>
                            ...
                            <div class="row g-2 justify-content-between">
                                @if (!empty($project->department))
                                    <div class="col-auto"><span
                                            class="badge rounded-pill bg-success">{{ $project->department->name ?? '' }}</span>
                                    </div>
                                @endif
                                <div class="col-auto"><span
