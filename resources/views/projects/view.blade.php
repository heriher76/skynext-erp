...
@section('action-btn')
    <div class="float-end">
        ...
        @can('create project task')
            @if (Auth::user()->type != 'client')
                @if (request()->channel != 'activity')
                    <a href="{{ route('task.material_used', $project->id) }}{{ request()->channel == 'activity' ? '?channel=activity' : '' }}"
                        class="btn btn-sm btn-primary">
                        {{ __('Material Used') }}
                    </a>
                @endif
                <a href="{{ route('projects.tasks.index', $project->id) }}{{ request()->channel == 'activity' ? '?channel=activity' : '' }}"
                    class="btn btn-sm btn-primary">
                    {{ __('Task') }}
                </a>
            @endif
        ...
        @can('edit project')
            <a href="#" data-size="lg"
                data-url="{{ route('projects.edit', $project->id) }}{{ request()->channel == 'activity' ? '?channel=activity' : '' }}"
                data-ajax-popup="true" data-bs-toggle="tooltip"
                title="{{ request()->channel == 'activity' ? 'Edit Activity' : 'Edit Project' }}"
                class="btn btn-sm btn-primary">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-auto mb-3 mb-sm-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-3">
                                        <small class="text-muted h6">{{ __('Total') }}</small>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="">
                                ...
                                <center>
                                    <h4 class="m-0">
                                        {{ \Auth::user()->priceFormat($project->budget - $project_data['expense']['total']) }}
                                    </h4>
                                </center>
                            </div>
                        </div>
