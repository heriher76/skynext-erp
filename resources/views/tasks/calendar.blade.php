                                    ...
                                    <div class="col-auto mb-3 mb-sm-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3 fc-event-title-container">
                                                <h6 class="m-0 text-sm fc-event-title text-primary">{{ $task['title'] }}
                                                </h6>
                                                <small class="text-muted">{{ $task['start'] }} to
                                                    {{ $task['end'] }}</small>
                                            </div>
                                        </div>
                                    </div>
        ...
        function get_data() {
            ...
            $.ajax({
                url: $("#task_calendar").val() +
                    "/calendar/get_task_data{{ request()->channel == 'activity' ? '?channel=activity' : '' }}",
