        ...
        <a href="#" class="b-brand">
            ...
            @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on')
                <img src="{{ $logo . '/' . (isset($company_logos) && !empty($company_logos) ? $company_logos : 'logo-dark.png') }}"
                    alt="{{ config('app.name', 'ERP') }}" class="logo logo-lg">
            @else
        ...
        @if (\Auth::user()->type != 'client')
                    ...
                    <li
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if ($userPlan->project == 1)
                                ...
                                @can('show hrm dashboard')
                                    <li
                                        class="dash-item {{ Request::route()->getName() == 'manage_activity.dashboard' ? ' active' : '' }}">
                                        <a class="dash-link"
                                            href="{{ route('manage_activity.dashboard') }}">{{ __('Activity ') }}</a>
                                    </li>
                                @endcan
                            @endif
            ...
            @if (!empty($userPlan) && $userPlan->project == 1)
                @if (Gate::check('manage project'))
                    {{-- <li
                        class="dash-item dash-hasmenu {{ Request::segment(1) == 'daily_activity' ? 'active' : '' }}">
                        <a href="{{ route('daily_activity.index') }}" class="dash-link">
                            <span class="dash-micon"><i class="ti ti-check"></i></span><span
                                class="dash-mtext">{{ __('Daily Activity') }}</span>
                        </a>
                    </li> --}}
                    <li class="dash-item dash-hasmenu">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-check"></i></span><span
                                class="dash-mtext">{{ __('Manage Activity') }}</span><span class="dash-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="dash-submenu">
                            @can('manage project')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('projects.index') }}?channel=activity">{{ __('Projects') }}</a>
                                </li>
                            @endcan
                            @can('manage project task')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('taskBoard.view', 'list') }}?channel=activity">{{ __('Tasks') }}</a>
                                </li>
                            @endcan
                            ...
                            @can('manage project task')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('task.calendar', ['all']) }}?channel=activity">{{ __('Task Calendar') }}</a>
                                </li>
                            @endcan
                            ...
                            @can('manage project task')
                                <li class="dash-item">
                                    <a class="dash-link"
                                        href="{{ route('project_report.index') }}?channel=activity">{{ __('Project Report') }}</a>
                                </li>
                            @endcan

                            @if (\Auth::user()->type == 'company' && Gate::check('manage project task stage'))
                                {{-- <li
