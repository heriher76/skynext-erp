                                ...
                                <div class="row mt-3">
                                    <div class="col">
                                        <small>
                                            ...
                                            @if ($bill->status == 0)
                                                <span
                                                    class="badge bg-primary">{{ __(\App\Models\Bill::$statues[$bill->status]) }}</span>
                                            @elseif($bill->status == 1)
                                                <span
                                                    class="badge bg-warning">{{ __(\App\Models\Bill::$statues[$bill->status]) }}</span>
                                            @elseif($bill->status == 2)
                                                <span
                                                    class="badge bg-danger">{{ __(\App\Models\Bill::$statues[$bill->status]) }}</span>
                                            @elseif($bill->status == 3)
                                                <span
                                                    class="badge bg-info">{{ __(\App\Models\Bill::$statues[$bill->status]) }}</span>
                                            ...
                                            <table class="table table-striped">
                                                <tr>
                                                    ...
                                                    <th class="text-end text-dark" width="12%">
                                                        {{ __('Price') }}<br>
                                                        <small
                                                            class="text-danger ">{{ __('after tax & discount') }}</small>
                                                    </th>
                                                </tr>
                                                @php
                                                    $totalQuantity = 0;
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            {{ $user->priceFormat($bill->getTotalDiscount()) }}</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">{{ $user->priceFormat($bill->getDue()) }}
                                                        </td>
                                                    </tr>
                                                </tfoot>
                                            </table>
