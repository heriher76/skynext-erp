...
class TransactionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(\Auth::user()->can('manage transaction'))
        {
            ...
            $credits = CreditNote::orderBy('id', 'desc');
            ...
            $transactions = $transactions->merge($credits->get())->sortBy('date');

            return view('transaction.index', compact('transactions', 'account', 'category', 'filter', 'accounts', 'credits'));
        }
        else
        {
