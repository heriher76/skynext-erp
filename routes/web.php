...
use App\Http\Controllers\MaterialUsedController;
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('/activity-dashboard', [DashboardController::class, 'activity_dashboard_index'])->name('manage_activity.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::group(
        [
            ...
            Route::post('invoice/project', [InvoiceController::class, 'project'])->name('invoice.project');
...
//    Route::get('timesheet-table-view', [TimesheetController::class, 'filterTimesheetTableView'])->name('filter.timesheet.table.view')->middleware(['auth', 'XSS']);
    ...
    Route::group(
        [
            ...
            Route::get('projects/{id}/material_used', [MaterialUsedController::class, 'material_used'])->name('task.material_used');
            Route::get('projects/{id}/material_used/create', [MaterialUsedController::class, 'create'])->name('task.material_used.create');
            Route::post('projects/{id}/material_used/store', [MaterialUsedController::class, 'store'])->name('task.material_used.store');
            Route::delete('projects/{id}/material_used/{mid}/destroy', [MaterialUsedController::class, 'destroy'])->name('task.material_used.destroy');
...
//    Route::get('{id}/plan-get-payment-status', [PaypalController::class, 'planGetPaymentStatus'])->name('plan.get.payment.status')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::group(
        [
            ...
            Route::get('daily_activity/{id}/reply', [DailyActivityController::class, 'reply'])->name('daily_activity.reply');
            Route::post('daily_activity/{id}/reply', [DailyActivityController::class, 'replyAnswer'])->name('daily_activity.reply.answer');
            Route::get('daily_activity/grid', [DailyActivityController::class, 'grid'])->name('daily_activity.grid');
